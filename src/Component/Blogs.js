...
const Blogs = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEdit) {
        await axios.put(`https://api.nncwebsitedevelopment.com/api/blogs/${formData._id}`, data);
        alert("Blog updated!");
      } else {
        await axios.post('https://api.nncwebsitedevelopment.com/api/blogs', data);
        alert("Blog created!");
      }
  ...
  const handleEdit = (index) => {
    ...
    setFormData({
      ...
      image: `https://api.nncwebsitedevelopment.com/uploads/blogs/${selected.image}`,
  ...
  const handleDelete = async (index) => {
    ...
    try {
      await axios.delete(`https://api.nncwebsitedevelopment.com/api/blogs/${blog._id}`);
