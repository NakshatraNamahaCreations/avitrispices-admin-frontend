...
function Customer() {
  ...
  const fetchCustomers = async () => {
    try {
      const response = await fetch('https://api.nncwebsitedevelopment.com/api/customers/all');
  ...
  const handleDelete = async (id) => {
    try {
      const response = await fetch(`https://api.nncwebsitedevelopment.com/api/customers/delete/${id}`, {
        method: 'DELETE',
      });
